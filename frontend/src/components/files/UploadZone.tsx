        ...
        {uploading ? (
          <div className="flex flex-col items-center gap-2.5 w-52">
            <div className="w-full bg-zinc-700 rounded-full h-2 overflow-hidden">
              <div
                className="h-full rounded-full transition-all duration-200 bg-linear-to-r from-violet-500 to-violet-400"
          ...
          <>
            <div className={`mb-3 p-3 rounded-xl transition-colors ${dragOver ? 'bg-violet-500/20' : 'bg-zinc-800/50'}`}>
              <svg className="w-10 h-8" viewBox="0 0 40 30" fill="none">
                <path d="M8 24c-3.31 0-6-2.69-6-6s2.69-6 6-6c.8-2.8 3.5-4.8 6.6-4.8 2.9 0 5.4 1.7 6.4 4.2 1.8-.8 3.8-1.2 6-1.2 4.4 0 8 3.6 8 8s-3.6 8-8 8H8z" fill="currentColor" className={`${dragOver ? 'text-violet-400/40' : 'text-zinc-600/50'} transition-colors`} />
